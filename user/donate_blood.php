...
$user = $conn->query("SELECT blood_group FROM users WHERE user_id=$user_id")->fetch_assoc();
...
.card-donate:hover { transform: translateY(-5px); box-shadow: 0 12px 35px rgba(0,0,0,0.2); }

.card-donate h3 { color: #C41E3A; font-weight: 700; margin-bottom: 25px; text-align: center; }
...
.alert-success, .alert-danger { text-align: center; font-weight: 600; border-radius: 12px; padding: 12px; }
</style>
</head>
<body>
